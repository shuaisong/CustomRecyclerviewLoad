...
import com.example.lenovo.customrecyclerviewload.listener.OnItemClickListener;
import com.example.lenovo.customrecyclerviewload.listener.OnItemLongClickListener;
import com.example.lenovo.customrecyclerviewload.listener.OnSwipeMenuClickListener;
...
/**
 */
public abstract class CommonBaseRecycleAdapter<T> extends BaseRecyclerviewAdapter<T> {
