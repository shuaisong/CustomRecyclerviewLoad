...
import com.example.lenovo.customrecyclerviewload.Util;
import com.example.lenovo.customrecyclerviewload.listener.OnLoadMoreListener;
...
public abstract class BaseRecyclerviewAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean mOpenLoadMore;//是否开发上拉功能
    ...
    public BaseRecyclerviewAdapter(Context context, List<T> data, boolean openLoadMore) {
        this.mContext = context;
        this.mDatas = data == null ? new ArrayList<T>() : data;
        this.mOpenLoadMore = openLoadMore;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_FOOTER_VIEW:
                ...
                viewHolder = new ViewHolder(mContext, mFooterLayout);
                break;
            case TYPE_EMPTY_VIEW:
                viewHolder = new ViewHolder(mContext, mEmptyView);
                break;
            case TYPE_NODATE_VIEW:
                viewHolder = new ViewHolder(mContext, new View(mContext));
                break;
            case TYPE_RELOAD_VIEW:
                viewHolder = new ViewHolder(mContext, mReloadView);
                break;
        }
        return viewHolder;
    }
     ...
     * @param layoutManager
     */
    protected void startLoadMore(RecyclerView recyclerView, final RecyclerView.LayoutManager layoutManager) {
